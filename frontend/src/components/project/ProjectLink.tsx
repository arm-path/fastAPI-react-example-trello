...
const ProjectLink = (props: ProjectLinkPropsType) => {
    ...
    const {id, title, invited, editForm} = props
    ...
    return (
        <div className={classes.linkContainer}>
            <div className={edit ? classes.hide : classes.show}>
                ...
                {!invited && <img className={classes.editImg} src={editIcon} alt=''
                                  onClick={() => {
            ...
            {!invited &&
                <>
                    ...
                    <div className={!edit ? classes.hide : classes.showFlex}>
                        <Input placeholder='Проект' value={editForm.title} error=''
                               styles={!edit ? classes.hide : classes.show}
                               onchangeHandler={(e: ChangeEvent<HTMLInputElement>) => {
                                   dispatch(changeTitleUpdateProjectAC(e.target.value))
                               }}/>
                        <div>
                            <img className={editForm.loading ? classes.saveLoadingImg : classes.saveImg} src={saveIcon}
                                 alt=''
                                 onClick={() => {
